window.i18n_en_us = {
  ...
  footer: {
    ...
    'Fairview_Park_Property_Management_Limited': 'Fairview Park Property Management Limited (Property Management Company Licence No.:C-052539)',
  ...
  home: {
    ...
    'Coach_Service': 'Coach Service',
    'content_1': 'Welcome to the website of Fairview Park Property Management Limited (Property Management Company Licence No.:C-052539). Residents can communicate with us by visiting our purpose-designed website. We hope to provide the following value-added services to our residents through this website:',
    'content_2': [
  ...
  aboutUs_Environmental_Service: {
    ...
    'content_2': [
      ...
      },
      {
        ...
        sub_content: [
          'Environmental Services Department are also responsible for servicing the green areas in our Estate including Town Centre, 66 green areas and grasslands, planting trees and placing plant pots along various main roads. And beautify the Fairview Park with the landscape design from the seasonal flowers. There is also a nursery in the estate to cultivate flower seedlings and saplings for the seasonal and festival necessary.',
    ...
    'content_6': [
      {
        ...
        content: 'Mon to Sat From 09:00 to 18:00 (Closed on all Public Holidays)',
      },
      {
        title: 'Security Department',
        content: 'Mon to Sun 24 Hours',
      },
      {
        title: 'Customer Service Department',
        content: 'Mon to Sun From 08:00 to 20:00',
      },
    ],
  ...
  sign_up: {
    ...
    'Login_Name': 'Login Name (Self Customize - it must contain only letters, numbers and symbol)',
  ...
  applyRCard: {
    ...
    'Application_materials':'Application Detail',
    'Name_of_Card_User':'1. Name of Card User (as appears in the ID document)',
    'Relation':'2. Relation with the Owner',
    ...
    'Please_upload_file_size':'*Please upload file size below 2MB and file format must be(.jpg | .jpeg | .png | .pdf).',
    'Please_fill_in_the_complete':'*Please fill in the complete 8- or 9-digit Octopus Number and the number in the bracket (if applicable).',
    'Please_upload_file_size_below_5MB':'*Please upload file size below 5MB and file format must be (.jpg | .jpeg | .png | .pdf)',
    'Undertakings':'Undertakings - Terms and Conditions',
    ...
    'Name_of_Card_User_2':'Name of Card User:',
    'Relation_2':'Relation:',
    'Octopus_Card_Number_2':'Octopus Card Number:',
  ...
  MACColumn_MAC_Members: {
    'MAC_Members': '11th MAC Members',
  },
  ...
  tenant_account_management:{
    ...
    The_source_of_the_last_activation_of_the_tenant_account:'Activated From:',
    Owner:'Owner',
    ...
    Confirmation_to_close_the_Tenant_Account:'Confirmation to close the Tenant Account',
    Close_account:'Tenant Account Closure',
    Once_the_account_is_closed:'Arrangement: After closing the tenant account, the account will no longer be available. After re-enable it, the password will be reset.',
    I_understand_and_agree_to_the_above_arrangement:'I understand and agree the above mentioned Arrangement of Tenant Account Closure',
    Return:'Return',
    Confirm:'Confirm',
    ...
    I_We_being_the_registered_house_owner:'I/We, being the registered house owner(s) (“the Owner”) in Fairview Park, wish to activate the tenant account of my/our house unit in Fairview Park (”the Tenant Account”) with Fairview Park Property Management Limited (”the Estate Management”). I/We declare that the tenant invited by me/us pursuant to these Terms and Conditions to use the Tenant Account (“the Tenant”) resides in my/our house unit in Fairview Park. I/We fully understand and agree to accept and be bound by all the following terms and conditions:<br/><br/><ul><li>If I/we am/are no longer the Owner of the house unit in Fairview Park, the Tenant Account will be closed.</li><li>The new Owner shall notify the Estate Management whether the Tenant will remain the same when there is a change of the house ownership. Otherwise, the Estate Management is entitled to close the Tenant Account without prior notice.</li><li>The Tenant Account is the property of the Estate Management. If the Tenant’s status is no longer eligible for using the Tenant Account, the Estate Management is entitled to close the Tenant Account that has been opened.</li><li>The Estate Management reserves the absolute right to reject the Owner’s application for the Tenant Account, or to close the Tenant Account that has been opened, if the Owner is in arrears with any fees including management fee payable to the Estate Management or in breach of the Deed of Mutual Covenant or Estate Rules.</li><li>If there are any abnormalities with the Tenant Account, the Owner shall either close the Tenant Account or notify the Estate Management immediately so as to enable the Estate Management to close the Tenant Account.</li><li>The Owner may authorize the Estate Management to assist in managing the Tenant Account and its usage as needed.</li><li>The Owner may copy the Tenant Account login information (“Login Information”) by himself/herself, and share the Login Information with the relevant Tenant, as well as inviting the Tenant to log in to the Tenant Account.</li><li>The Owner shall share the Login Information properly.  Under any circumstances, the Estate Management shall not be responsible for the arrangements and consequences of the Owner sharing the Login Information.</li><li>By sharing the Login Information to the Tenant, the Owner consents to allow the Tenant to access the Mobile App, and to apply for the related services provided by the Estate Management through the Mobile App from time to time.</li><li>The Estate Management reserves the right to revise these Terms and Conditions and/or to introduce additional terms and conditions at any time after providing reasonable notice in advance to the Owner.</li>',
    I_Accept_and_Understand_the_Terms_and_Agreement:'I Accept and Understand the Terms and Agreement',
    Cancel:'Cancel',
