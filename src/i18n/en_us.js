...
export default {
    ...
    "Same as the owner is name on the monthly statement, including symbols": "Same as the owner's name on the monthly statement, including symbols",
    'Account Number (On Account Statement)': 'Account Number (On Account Statement)',
    'A-BRS-100 must be filled in as ABRS100': 'A-BRS-100 must be filled in as ABRS100',
