 ...
 * @LastEditTime: 2022-11-25 01:11:00
  ...
  <div class="wall-color-series">
    ...
    <div class="banner">
      ...
      <p>
        ...
        }}{{ fairview_park_lang === "en_us" ? "&nbsp;Schedule" : "系列" }}
      </p>
    </div>
    <!-- 內容 -->
  ...
  data() {
    return {
      ...
      image_en: [
        {
          url: new URL(
            "../../assets/image/prospective buyer/colour_schedule_en.jpeg",
            import.meta.url
          ).href,
          alt: "",
        },
      ...
      image: [
        {
          url: new URL(
            "../../assets/image/prospective buyer/colour_schedule.jpeg",
            import.meta.url
          ).href,
          alt: "",
        },
