 ...
 * @LastEditTime: 2022-09-25 13:39:56
                    ...
                    <td valign="top">
                      ...
                      >
                        <tbody style="border: 1px solid #275535; border-radius: 5px">
                          <tr
                            ...
                            "
                          >
                            <td style="padding-left: 25px; font-size: 20px; color: #fff">
                              {{fairview_park_lang ==='en_us'?'To New Owners or Prospective Buyers':'致新業主或準買家'}}
                                      ...
                                      >
                                        <tbody>
                                          <tr>
                                            <td class="style13">
                                              <p>
                                                {{fairview_park_lang ==='en_us'?'New owners are reminded that the Estate Management Office handles takes a serious view of the following cases which cause nuisance:':'謹提醒各新業主，管理處會嚴謹處理以下構成公眾滋擾的事項：'}}
                                          ...
                                          <tr
                                            v-for="(item, index) in fairview_park_lang ===
                                            'en_us'
                                              ? [
                                                  {
                                                    title: 'Unauthorized additions / alterations',
                                                    des:
                                              ...
                                              : [{
                                                    title: '違例建築',
                                                    des:
                                                      '準買家應確保前任業主已清理及修正單位所有違反公契之加建/改建。作為新業主，他/她必須對前任業主遺留下來之所有違反公契及屋邨守則事項負上全部責任，並可能面對管理處採取之法律行動，而要清理及修正違例之加建/改建，及支付相關的法律費用。',
                                                  },
                                                  {
                                                    title: '街道停泊',
                                                    des:
                                                      '錦綉花園的街道並非為停泊車輛而設計，因此，業主應確保其所有車輛均可泊進其單位之車房內。管理處有權將擅自停放於屋邨道路、街道或公用地方的車輛扣押或拖離。',
                                                    tip:
                                                      '【詳情請參閱屋邨守則丁章規條IV】',
                                                  },
                                                  {
                      ...
                      <div
                        v-for="(item, index) in fairview_park_lang === 'en_us'
                          ? [
                              {
                                title: 'What are the standards of fence, garden gate and rolling shutter?',
                                des:
                              ...
                              {
                                title: 'What are the standards on the erection of carport cover?',
                                des:
                              ...
                              {
                                title: 'Are owners allowed to change the colour of exterior walls of their unit?',
                                des:
                              ...
                              {
                                title: 'Are owners allowed to seal up the manhole covers?',
                                des:
                              ...
                              {
                                title: 'Are owners allowed to erect fixed type canopy in the garden or balcony?',
                                des:
                              ...
                              {
                                title: 'Are owners allowed to carry out alteration or cutting of exterior or interior wall panels in their unit?',
                              ...
                              {
                                title: 'Are owners allowed to construct or place combination houses in garden, balcony or carport?',
                                des:
                              ...
                              {
                                title: 'What are the methods for payment of management fee?',
                                des:
                              ...
                              {
                                title: 'What are the procedures for transferring the foundation fund?',
                                des:
                              ...
                              {
                                title: 'What are the procedures for applying “Entry Label”?',
                                des:
                          ...
                          : [
                              ...
                              },
                              {
                                ...
                                tip:
                                  '【詳情請參閱屋邨守則甲章規條II(1)、丙章規條III(2)及III(4)】',
                              },
                              {
                                title: '業主可否拆除單位外牆或室內牆壁？',
                                des: '業主不許改動屋宇主要結構，如支柱、橫樑及結構牆。',
                                tip:
                                  '【詳情請參閱屋邨守則甲章規條II(2)、丙章規條II(1)、II(2)及II(3)】',
                              },
                              {
                                ...
                                tip:
                                  '【詳情請參閱屋邨守則甲章規條II(1)、乙章規條III(2)、丙章規條III(2)及V】',
                              },
                              {
                                title: '業主可否把車房圍封？',
                                des:
                      ...
                      >
                        <table width="700" border="0" cellpadding="5" cellspacing="0">
                          <tbody>
                            ...
                            <tr>
                              <td width="30" height="25" valign="top" class="style13">
