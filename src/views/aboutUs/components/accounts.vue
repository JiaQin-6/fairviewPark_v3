 ...
 * @LastEditTime: 2022-11-03 00:14:42
        ...
        <h3
          ...
          v-html="
            $t('Accounts')
              .replace(
                'Customer',
                '<b style=border-bottom-width:4px;border-bottom-color:#f0be64;border-bottom-style:solid;>Accounts</b>'
              )
              .replace(
                '會計',
                '<b style=border-bottom-width:4px;border-bottom-color:#f0be64;border-bottom-style:solid;>會計</b>'
              )
          "
        ></h3>
        <div>
